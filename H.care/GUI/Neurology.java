...
public class Neurology extends JFrame implements  ActionListener
{
        ...
        // btn1.add(pic1);
          ...
          intro=new JLabel("Doctors of Neurology");
          ...
          btn1 = new JButton();
          btn1.setText("<html>Dr. Mohammed Wahidur Rahman<br />MBBS, DA, MD (USA), DO (USA), Neurology Residency (USA), Fellow in Movement Disorder (USA), Fellow in Clinical Neurophysiology (USA)");
        ...
        // frame.add(btn1);
         ...
         btn2= new JButton();
         btn2.setText("<html>Associate Prof. Dr. Sk. Mahbub Alam<br />MBBS, MD (Neurology), BSMMU Fellowship in Neuro-electrophysiology (UM,Malaysia)");
    ...
    //    frame.add(btn2);
        ...
        // public String getDoctor(String doctroname)
        // {
        //     return doctroname;

        // }
//         public void appoinmentTime(String doctor, String date, String time )
//         {
//             this.doctor = doctor;
//             this.date = date;
//             this.time = time;
...
// }
        ...
        public void actionPerformed(ActionEvent ae) {
            ...
            if (ae.getSource() == btn1) {
                selectedDoctor = "Dr. Mohammed Wahidur Rahman"; // Set the selected doctor's name
             ...
             {
                selectedDoctor = "Associate Prof. Dr. Sk. Mahbub Alam"; // Set the selected doctor's name
                writeToAppointmentFile(selectedDoctor);
                new Appoinment(new UserDashboard(user));
                this.setVisible(true);
                this.setVisible(false);
