...
public class  Orthopedic extends JFrame implements  ActionListener
{
       ...
       public  Orthopedic(){
        ...
        intro=new JLabel("Doctors of Orthopedic");
        ...
        btn1 = new JButton();
        btn1.setText("<html>Brig. Gen. Prof. Dr. Moklesur Rahman<br />MBBS (DMC), MS (Ortho), FACS (USA), Fellow Hand, Upper Limb & Microsurgery (Thailand), Fellow Hip & Knee Joint Replacement Surgery (India)</html>");
    ...
    // //    btn2.addActionListener(this);
       ...
       btn2= new JButton();
       btn2.setText("<html>Dr. Md. Fazlul Hoque<br />MBBS, D. (Ortho), FA (Ortho), FAMA Trained in Orthopedic and Spinal Surgery (UK & USA)</html>");
       ...
       panel3.add(backbtn );
        ...
        public void actionPerformed(ActionEvent ae) {
            ...
            if (ae.getSource() == btn1)
             {   selectedDoctor = "Brig. Gen. Prof. Dr. Moklesur Rahman"; // Set the selected doctor's name
             ...
             { 
                 selectedDoctor = "Dr. Md. Fazlul Hoque"; // Set the selected doctor's name
                 writeToAppointmentFile(selectedDoctor);
                 new Appoinment(new UserDashboard(user));
                 this.setVisible(true);
                 this.setVisible(false);
