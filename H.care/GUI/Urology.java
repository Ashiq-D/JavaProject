...
public class Urology extends JFrame implements ActionListener
{
       ...
       User user;
        ...
        // btn1.add(pic1);
           ...
           intro=new JLabel("Doctor List of Urology");
          ...
          btn1 = new JButton();
          btn1.setText("<html>Dr. Md. Rashedul Islam<br />MBBS, FCPS (Medicine), FCPS (Urology),<br /> MRCP (UK), FACP (USA)</html>");
        ...
        // frame.add(btn1);
          ...
          btn2= new JButton();
          btn2.setText("<html>DR. RUMANA HABIB<br />MBBS, FCPS (Urology), <br />D-MED (UK), FACP (USA), FRCP (UK)</html>");
    ...
    //    frame.add(btn2);
        ...
        public void actionPerformed(ActionEvent ae) {
            if (ae.getSource() == btn1)
             {  selectedDoctor = "Dr. Md. Rashedul Islam"; // Set the selected doctor's name
             ...
             {   selectedDoctor = "DR. RUMANA HABIB"; // Set the selected doctor's name
                 writeToAppointmentFile(selectedDoctor);
                 new Appoinment(new UserDashboard(user));
                 this.setVisible(true);
                this.setVisible(false);
